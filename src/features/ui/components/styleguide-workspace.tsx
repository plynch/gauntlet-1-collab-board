    ...
    <main className="min-h-screen bg-slate-50 px-6 py-10 text-slate-900">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <header className="space-y-3">
          ...
          <h1 className="m-0 text-3xl font-bold tracking-tight">CollabBoard Style Guide</h1>
          <p className="m-0 max-w-3xl text-sm text-slate-600">
            Minimal, calmly reassuring UI primitives and board-specific layout components.
          </p>
        </header>
        ...
        <section className="grid gap-4 md:grid-cols-2">
          <Card className="space-y-3">
            ...
            <CardDescription>Core action styles for board and settings UI.</CardDescription>
          ...
          <Card className="space-y-3">
            ...
            <CardDescription>Clean forms with low visual noise.</CardDescription>
            <Input
              value={sampleText}
        ...
        <section className="space-y-4">
          ...
          <p className="m-0 text-sm text-slate-600">
            These containers support 1x1, 2x2, and NxN layouts with intentional negative space
            for additional board objects.
          </p>

          <div className="grid gap-6">
            <Card className="space-y-3">
              <CardTitle>1x1 Container</CardTitle>
              <GridContainer rows={1} cols={1} minCellHeight={140} containerTitle="One Section" />
            </Card>
